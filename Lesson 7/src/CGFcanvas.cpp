...
const unsigned char CANVAS_CLEAR_COLOR = 255;
const unsigned char CANVAS_DEFAULT_COLOR = 0;
const unsigned char CANVAS_PIXEL_SIZE = sizeof(CANVAS_PIXEL_TYPE);

bool CANVAS_NORMAL_MODE = 0;
bool CANVAS_XOR_MODE = 1;
